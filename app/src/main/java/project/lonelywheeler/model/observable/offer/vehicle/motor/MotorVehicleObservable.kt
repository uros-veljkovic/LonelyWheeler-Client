...
/*    fun addPicture(bitmap: Bitmap) {
    ...
    override fun toEntity(): MotorVehicleEntity {
        return MotorVehicleEntity(
            this@MotorVehicleObservable.id,
            this@MotorVehicleObservable.sellerId,
            this@MotorVehicleObservable.basicInfo.toEntity(),
            this@MotorVehicleObservable.condition.name,
            this@MotorVehicleObservable.pictures.convertToStringList(),
            this@MotorVehicleObservable.valueFixed,
            this@MotorVehicleObservable.firstOwner,
            this@MotorVehicleObservable.sellerInForExchange,
            this@MotorVehicleObservable.otherInfo,
            this@MotorVehicleObservable.colorExterior,
            this@MotorVehicleObservable.colorInterior,
            this@MotorVehicleObservable.materialInterior,
            this@MotorVehicleObservable.carBodyType.name,
            this@MotorVehicleObservable.fuelType.name,
            this@MotorVehicleObservable.emissionStandard.name,
            this@MotorVehicleObservable.gearboxType.name,
            this@MotorVehicleObservable.steeringWheelSide.name,
            this@MotorVehicleObservable.drivetrain.name,
            this@MotorVehicleObservable.maxSpeed,
            this@MotorVehicleObservable.maxHorsePower,
            this@MotorVehicleObservable.mileage,
            this@MotorVehicleObservable.cubicCapacity,
            this@MotorVehicleObservable.registeredUntil.toLong(),
            this@MotorVehicleObservable.numberOfDoors,
            this@MotorVehicleObservable.numberOfSeats,
            this@MotorVehicleObservable.hasMultimedia,
        )
    }
}
